...
app.put("/editar-info/:id", (req, res) => {
    ...
    let SQL = ("UPDATE Usuarios SET usuario_nome = '"+nome+"', nome_usuario = '"+username+"', usuario_email = '"+useremail+"' WHERE usuario_ID = '"+id+"'")
...
app.put("/editar-info-email/:id", (req, res) => {
    ...
    let SQL = ("UPDATE Usuarios SET usuario_email = '"+useremail+"' WHERE usuario_ID = '"+id+"'")
...
app.put("/editar-info-usuario-email/:id", (req, res) => {
    ...
    let SQL = ("UPDATE Usuarios SET nome_usuario = '"+username+"', usuario_email = '"+useremail+"' WHERE usuario_ID = '"+id+"'")
...
//Usario email,nome email, usario nome e email
//EMAIL
