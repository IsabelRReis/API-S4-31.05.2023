      ...
      Swal.fire({
        ...
        if (result.isConfirmed !== true) {
          ...
          switch (result.isConfirmed) {
            ...
            //EMAIL
            case (nome === '' && apelido === '' && email !== ''):
              Axios.put(`http://localhost:3001/editar-info-email/${id}`, {
                useremail: email
              }).then((response) => {
                if (response.data.msg !== '') {
                  msgSucesso()
                  setIsOpenPopup(this, false)
                  return Axios.post(`http://localhost:3001/registrarAcaoEmail/${id}`)
                  .then((result) => {
                    console.log(result.data.msg)
                  })
                }
            ...
            case (nome !== '' && apelido === '' && email !== ''):
              ...
              Axios.put(`http://localhost:3001/editar-info-nome-email/${id}`, {
                useremail: email,
                nome: nome
              }).then((response) => {
                if (response.data.msg !== '') {
                  msgSucesso()
                  setIsOpenPopup(this, false)
                  return Axios.post(`http://localhost:3001/registrarAcaoNomeEmail/${id}`)
                  .then((result) => {
                    console.log(result.data.msg)
                  })
                }
            ...
            case (nome === '' && apelido !== '' && email !== ''):
              Axios.put(`http://localhost:3001/editar-info-usuario-email/${id}`, {
                useremail: email,
                username: apelido
              }).then((response) => {
                if (response.data.msg !== '') {
                  msgSucesso()
                  setIsOpenPopup(this, false)
                  return Axios.post(`http://localhost:3001/registrarAcaoUsuarioEmail/${id}`)
                  .then((result) => {
                    console.log(result.data.msg)
                  })
                }
            ...
            case (nome !== '' && apelido !== '' && email !== ''):
              Axios.put(`http://localhost:3001/editar-info/${id}`, {
                ...
                if (response.data.msg !== '') {
                  msgSucesso()
                  setIsOpenPopup(this, false)
                  return Axios.post(`http://localhost:3001/registrarAcaoNomeUsuarioEmail/${id}`)
                  .then((result) => {
                    console.log(result.data.msg)
                  })
                }
